...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot get product. Error: " + err_1);
    ...
    ProductStore.prototype.create = function (ProductStore) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [ProductStore.name, ProductStore.price])];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new product " + name + ". Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
